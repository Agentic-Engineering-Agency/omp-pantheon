...
| Verified autonomy | No Pantheon-specific durable objective runtime. | Adds opt-in `/autonomy`, native-goal and verification gates, broker-managed session resumption, leased/fenced command delivery, persisted scheduling, and bounded retries. |
